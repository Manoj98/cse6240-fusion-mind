...
def construct_graph(cpnet_csv_path, cpnet_vocab_path, output_path, prune=True):
    """
    Construct unpruned and pruned graphs for concept net. Also, create an undirected graph with both the tuples - (obj, rel, subj) and (subj, inv(rel), obj) 
    """
    ...
    with open(cpnet_csv_path, "r", encoding="utf8") as fin:
        ...
        for line in tqdm(fin, total=nrow):
            ...
            ## Add both subj -> obj and obj -> subj relations in the graph
